                ...
                <div className = "card col-md-6 offset-md-3">
                    ...
                    <div className = "card-body">
                        ...
                        {/* <div className = "row">
                            ...
                            <div> { this.state.patient.treatmentHistory.dateOfArrival }</div>
                        </div>
                        <div className = "row">
                            <label> Treatment Cost: </label>
                            <div> { this.state.patient.treatmentHistory.treatmentCost }</div>
                        </div>
                        <div className = "row">
                            <label>Medication: </label>
                            <div> { this.state.patient.treatmentHistory.consultation }</div>
                        </div>
                        <div className = "row">
                            <label>Disease: </label>
                            <div> { this.state.patient.treatmentHistory.disease}</div>
                        </div> */}
                    </div>
